...
LAYER_INFO = {
    ...
    "network": {
        ...
        "questions": ["What does configurational analysis mean?", "How do I use the filters", "How do I use the histograms, what do they mean?", "What is Integration (NAIN)", "What is Route Choice (NACH)?", "What is Kementrality (KBC)", "What is Degree Centrality (NADC)", "What the NAIN, NACH and NADC Metric Measures represent?", "What are Connectivity and Angular Connectivity" ]
    },
    "crime_master_toggle": {
