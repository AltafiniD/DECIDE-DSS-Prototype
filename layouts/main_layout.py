...
def create_layout():
    ...
    for layer_id, config in LAYER_CONFIG.items():
        ...
        if layer_type == 'polygon':
            ...
            if layer_id == 'buildings':
                ...
                layer_args.update({'extruded': False, 'get_fill_color': '[0, 255, 255, 120]', 'stroked': False, 'pickable': False})
    ...
    initial_visible_layers = [
        layer for layer_id, layer in all_layers.items()
        if LAYER_CONFIG[layer_id].get('visible', False)
    ]
        ...
        children=[
            ...
            html.Div(
                dash_deck.DeckGL(
                    ...
                    data=pdk.Deck(
                        layers=initial_visible_layers, initial_view_state=initial_view_state,
            ...
            html.Div(
                style={"position": "absolute", "top": "20px", "left": "20px", "zIndex": "1", "backgroundColor": "rgba(255, 255, 255, 0.9)", "padding": "15px", "borderRadius": "8px", "boxShadow": "0 4px 6px rgba(0, 0, 0, 0.1)", "width": "220px"},
                children=[
                    ...
                    dcc.Slider(
                        ...
                        marks={0: {'label': '2D', 'style': {'fontWeight': 'bold'}}, 60: {'label': '3D', 'style': {'fontWeight': 'bold'}}},
            ...
            html.Div(
                id="selection-info-panel",
                className="selection-info-panel",
                children=[
                    dcc.Markdown(id="selection-info-display")
                ]
            ),
